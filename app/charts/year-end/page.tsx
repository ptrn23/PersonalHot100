  ...
  if (uniqueYears.length === 0) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-white p-10">
        <h1 className="mb-4 text-2xl font-bold">No Year-End Data</h1>
  ...
  return (
    <main className="min-h-screen bg-white pb-24 text-gray-900">
      ...
      {numberOneHits.length > 0 && (
        <div className="mt-16">
          <div className="mx-auto mb-6 flex max-w-[1450px] items-center justify-between px-8">
            <h2 className="text-3xl leading-none font-black tracking-tighter text-gray-900 uppercase">
