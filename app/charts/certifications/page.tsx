...
export default function CertificationsUnderConstruction() {
  return (
    <div className="font-geist flex min-h-[75vh] w-full flex-col items-center justify-center bg-gray-50 p-6 select-none">
      <div className="flex w-full max-w-xl flex-col items-center border-4 border-black bg-white p-12 text-center shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
        ...
        <Link
          ...
          className="border-2 border-black bg-black px-8 py-4 text-xs font-black tracking-widest text-white uppercase transition-all hover:-translate-y-1 hover:bg-[#B30000] hover:shadow-[4px_4px_0px_0px_rgba(179,0,0,1)]"
        >
          Back to {CHART_NAME}
        </Link>
      </div>
