      ...
      <div className="max-w-5xl mx-auto px-10 md:px-0">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between border-b-4 border-black pb-8 mb-16">
          ...
          <div className="text-right mt-6 md:mt-0">
            ...
            <span className="text-gray-500 font-medium text-sm">v1.0.0</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16">
          <div className="md:col-span-7 flex flex-col gap-8">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              As an avid music listener and data enthusiast, I built Personal
              Charts to answer a simple question: "What would my personal Hot
              100 look like?"
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
              The project is a love letter to music discovery and data-driven
              insights, offering users a unique way to track their listening
              habits and uncover previous chapters of their musical journey.
              Maybe you want to see what you were listening to in your first
              year of college, or that time you were obsessed with a particular
              artist. Whether you're a casual listener or a chart-topping
              superfan, Personal Charts provides a dynamic and personalized
