    ...
    <footer className="w-full bg-[#f5f5f5] text-black border-t border-gray-300 mt-auto antialiased">
      <div className="max-w-[1400px] mx-auto px-8 py-12 grid grid-cols-1 md:grid-cols-12 gap-10 items-center md:items-start">
        ...
        <div className="md:col-span-4 flex flex-col h-full justify-between">
          <div>
            <h4 className="font-black uppercase text-xs tracking-wider text-gray-900 mb-2">PERSONAL CHARTS</h4>
          ...
          <div className="border border-gray-300 p-3 rounded bg-white/50 text-[11px] font-bold uppercase tracking-wider text-gray-600 flex flex-col gap-1.5">
            ...
            <div className="flex justify-between">
              <span>Architecture:</span> <span className="font-mono text-black">Next.js App Router</span>
            </div>
          </div>
        </div>

        <div className="md:col-span-2">
          <h4 className="font-black uppercase text-xs tracking-wider text-gray-900 mb-4">SITEMAP</h4>
          <ul className="flex flex-col gap-2.5 text-xs font-bold text-gray-600 uppercase tracking-wide">
            <li><Link href="/" className="hover:text-[#B30000] transition-colors">Hot 100 Charts</Link></li>
            <li><span className="text-gray-400 cursor-not-allowed">Top Albums 20</span></li>
            <li><span className="text-gray-400 cursor-not-allowed">Artist 20</span></li>
            <li><span className="text-gray-400 cursor-not-allowed">Archive</span></li>
            <li><span className="text-gray-400 cursor-not-allowed">About</span></li>
          </ul>
        </div>

        <div className="md:col-span-2">
          <h4 className="font-black uppercase text-xs tracking-wider text-gray-900 mb-4">ARCHITECTURE</h4>
      ...
      <div className="w-full bg-white border-t border-gray-200 py-4 px-8">
        <div className="max-w-[1400px] mx-auto flex flex-col sm:flex-row justify-between items-center gap-4 text-[10px] font-bold uppercase tracking-widest text-gray-400">
          ...
          <div className="font-mono font-medium text-gray-400 flex items-center gap-2">
            <svg viewBox="0 0 76 65" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 text-black">
