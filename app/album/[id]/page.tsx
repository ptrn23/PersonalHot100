...
export default async function AlbumPage({
  ...
  return (
    <main className="min-h-screen bg-white text-gray-900 p-10">
      <Link href="/" className="text-sm font-bold text-gray-400 hover:text-black uppercase tracking-widest mb-8 block transition-colors">
        Back to Hot 100
      </Link>
      ...
      <div className="max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gray-50 border border-gray-200 p-6 rounded-lg col-span-2">
            <h2 className="font-black uppercase text-xl mb-2">Tracklist Performance</h2>
            <p className="text-sm text-gray-500">
              TO DO: Generate a table of every song on <strong>{album.title}</strong> that charted on the Hot 100, displaying their individual peaks and then total units.
            </p>
          </div>
          
          <div className="bg-blue-50 border border-blue-200 p-6 rounded-lg flex flex-col justify-center items-center text-center">
            <span className="font-bold text-blue-800 text-xs uppercase mb-1">Total Era Units</span>
