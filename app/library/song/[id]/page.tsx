                    ...
                    <div className="flex flex-col w-full">
                      <div className="flex justify-between items-start">
                        <div className="flex items-center text-[15px] text-gray-500 whitespace-nowrap overflow-hidden">
                          ...
                          <svg viewBox="0 0 24 24" aria-label="Verified account" className="w-5 h-5 ml-1 text-blue-500 fill-current shrink-0">
                      ...
                      <div className="flex justify-between items-center mt-3 text-gray-500 w-full max-w-md">
                        ...
                        <div className="flex items-center space-x-1 border-l border-gray-200 pl-4 ml-4">
                          ...
                          <div className="p-2 rounded-full hover:bg-blue-50 hover:text-blue-500 transition-colors">
                            <svg viewBox="0 0 24 24" className="w-[18px] h-[18px] fill-current"><g><path d="M12 2.59l5.7 5.7-1.41 1.42L13 6.41V16h-2V6.41l-3.3 3.3-1.41-1.42L12 2.59zM21 15l-.02 3.51c0 1.38-1.12 2.49-2.5 2.49H5.5C4.11 21 3 19.88 3 18.5V15h2v3.5c0 .28.22.5.5.5h12.98c.28 0 .5-.22.5-.5L19 15h2z"></path></g></svg>
                          </div>
                        </div>
                      </div>
