...
import { ArrowLeft, Database, Tag, ExternalLink } from "lucide-react";
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                {spotifyId ? (
                  <Link
                    ...
                    className="group flex items-center gap-1.5 border-2 border-[#1DB954] bg-black px-3 py-1.5 font-mono text-xs font-bold text-[#1DB954] uppercase shadow-sm transition-colors hover:bg-[#1DB954] hover:text-white"
                  >
                    ...
                    {spotifyId}
                    <ExternalLink size={12} className="ml-0.5 opacity-50 group-hover:opacity-100" />
                  </Link>
                ) : (
                  <div className="flex items-center gap-1.5 border-2 border-white/30 bg-black/50 px-3 py-1.5 font-mono text-xs font-bold text-white/50 uppercase shadow-sm">
                ...
                {genres.length > 0 ? (
                  genres.map((g, idx) => (
                    <div
                      key={idx}
                      className="flex items-center gap-1.5 border-2 border-white bg-black px-3 py-1.5 font-mono text-xs font-bold text-white uppercase shadow-sm"
                    >
                      <Tag size={14} />
                      {g}
                    </div>
